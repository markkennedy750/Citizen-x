export default feeds = [
    ...
    followUp: [
      {
        ...
        image: [
          require("../assets/reportImage/fakeprod1.jpg"),
          require("../assets/reportImage/fakeprod2.jpg"),
          require("../assets/reportImage/fakeprod.jpg"),
        ],
      },
    ],
  },
    ...
    followUp: [
      {
        ...
        image: [
          require("../assets/reportImage/roadImag2.jpg"),
          require("../assets/reportImage/roadImag1.jpg"),
          require("../assets/reportImage/roadImag.jpg"),
        ],
      },
    ],
  },

  {
    ...
    image: [
      require("../assets/reportImage/electionV.jpg"),
      require("../assets/reportImage/electionV2.jpg"),
    ],
    numOfLike: 110,
    numberOfView: 220,
    followUp: {
...

  {
    ...
    image: [
      require("../assets/reportImage/mobAttack.jpg"),
      require("../assets/reportImage/mobAttack2.jpg"),
    ],
    numOfLike: 310,
    numberOfView: 520,
    followUp: [
  ...
  },
  {
    ...
    image: [
      require("../assets/reportImage/reportCase1.jpg"),
      require("../assets/reportImage/reportCase2.jpg"),
    ],
    numOfLike: 310,
    numberOfView: 520,
    followUp: [
